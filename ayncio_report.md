...
打个比方，IO就像是平底锅，IO操作是煎蛋，首先你得去拿鸡蛋，这就是CPU操作。很多人想吃煎蛋，但是平底锅只有一个；拿鸡蛋很快，可是煎鸡蛋要花点时间。同步就是一个人在煎蛋的时候，其他人就干看着等，效率是很低的。实际上在等待煎蛋的时间，其他人可以去拿蛋，这就是异步。可是异步也不能同时很多人一起去煎蛋，不然大家很快拿完鸡蛋还是得等待正在煎蛋的人，导致过久的等待（误判为超时丢包），所以我们要分批次放人进厨房。

第一种方法是减少了一次性到达IO层的线路，从而减少堵塞率，就是减少一次性进入厨房的人数；第二种方法则是防止让每条线路一直占用资源，一定时间后就会sleep，给其他线路连接机会，就是一个人把蛋打下去之后就先休息一下，让下一个人拿锅做准备（这时候视为这第二个人结束了等待，delay时间缩短），等蛋熟了回来拿走。可是这两种方法都有很强的弊端：1. 减少线程数同时及也会增长运行时间，在准确率和速率两者间找到较好的平衡相对较难。2. 同理，sleep也会增长运行时间，具体应该sleep的时间也难以界定。
